...
#include "DWAbilityTask_PlayMontageAndWaitForEvent.generated.h"
 ...
 */
UCLASS()
class DREAMWORLD_API UDWAbilityTask_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()

public:
	// Constructor and overrides
	UDWAbilityTask_PlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	static UDWAbilityTask_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
